...
class HCANet(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        # print("self.output(out_dec_level1.unsqueeze(2)).squeeze(2)= ", self.output(out_dec_level1.unsqueeze(2)).shape)
        # print("inp_img.squeeze(1).unsqueeze(2)= ", inp_img.squeeze(1).shape)
        # print("(self.output(out_dec_level1.unsqueeze(2)).squeeze(2) + inp_img.squeeze(1)).unsqueeze(1)= ",
        #       (self.output(out_dec_level1.unsqueeze(2)).squeeze(2) + inp_img.squeeze(1)).unsqueeze(1).shape); exit()

        out_dec_level1 = (self.output(out_dec_level1.unsqueeze(2)).squeeze(2) + inp_img.squeeze(1)).unsqueeze(1)
